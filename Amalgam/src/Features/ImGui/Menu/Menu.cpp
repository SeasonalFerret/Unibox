				...
				for (int _iBind = 0; _iBind < F::Binds.m_vBinds.size(); _iBind++)
				{
					...
					case BindEnum::Misc:
						...
						case BindEnum::MiscEnum::SpectatedThird:
							...
							break;
						default:
							if (_tBind.m_iInfo >= BindEnum::MiscEnum::ConditionStart)
							{
								sType = "cond";
								sInfo = std::format("{}", _tBind.m_iInfo - BindEnum::MiscEnum::ConditionStart);
							}
							break;
						}
						break;
					...
					if (FBeginPopup(std::format("RightClicked{}", _iBind).c_str()))
					{
						...
						case BindEnum::Misc: FDropdown("Misc", &_tBind.m_iInfo, { "Spectated", "Spectated 1st", "Spectated 3rd", "##Divider",
							"TF_COND_AFTERBURN_IMMUNE", "TF_COND_AIMING", "TF_COND_AIR_CURRENT", "TF_COND_BALLOON_HEAD", "TF_COND_BLAST_IMMUNE",
							"TF_COND_BLASTJUMPING", "TF_COND_BLEEDING", "TF_COND_BULLET_IMMUNE", "TF_COND_BURNING", "TF_COND_BURNING_PYRO",
							"TF_COND_CANNOT_SWITCH_FROM_MELEE", "TF_COND_COMPETITIVE_LOSER", "TF_COND_COMPETITIVE_WINNER", "TF_COND_CRITBOOSTED",
							"TF_COND_CRITBOOSTED_BONUS_TIME", "TF_COND_CRITBOOSTED_CARD_EFFECT", "TF_COND_CRITBOOSTED_CTF_CAPTURE",
			...
			if (tBind.m_iVisibility == BindVisibilityEnum::Always || tBind.m_iVisibility == BindVisibilityEnum::WhileActive && tBind.m_bActive || m_bIsOpen)
			{
				...
				case BindEnum::Misc:
					...
					case BindEnum::MiscEnum::SpectatedThird:
						...
						break;
					default:
						if (tBind.m_iInfo >= BindEnum::MiscEnum::ConditionStart)
						{
							sType = "cond";
							sInfo = std::format("{}", tBind.m_iInfo - BindEnum::MiscEnum::ConditionStart);
						}
						break;
					}
					break;
