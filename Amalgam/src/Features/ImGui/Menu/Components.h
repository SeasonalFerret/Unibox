...
namespace ImGui
{
	...
	inline T& FGet(ConfigVar<T>& var, bool bDisable = false)
	{
		...
		if (bDisable)
		{
			...
			{
				PushTransparent(CurrentBind != iBind && !(var.m_iFlags & NOBIND) && (!Vars::Config::LoadDebugSettings.Value || !(var.m_iFlags & NOSAVE)));
	...
	inline void DrawBindInfo(ConfigVar<T>& var, T& val, const std::string& sBind, bool bNewPopup, bool& bLastHovered)
	{
		...
		case BindEnum::Misc: FDropdown("Misc", &tBind.m_iInfo, { "Spectated", "Spectated 1st", "Spectated 3rd", "##Divider",
			"TF_COND_AFTERBURN_IMMUNE", "TF_COND_AIMING", "TF_COND_AIR_CURRENT", "TF_COND_BALLOON_HEAD", "TF_COND_BLAST_IMMUNE",
			"TF_COND_BLASTJUMPING", "TF_COND_BLEEDING", "TF_COND_BULLET_IMMUNE", "TF_COND_BURNING", "TF_COND_BURNING_PYRO",
			"TF_COND_CANNOT_SWITCH_FROM_MELEE", "TF_COND_COMPETITIVE_LOSER", "TF_COND_COMPETITIVE_WINNER", "TF_COND_CRITBOOSTED",
			"TF_COND_CRITBOOSTED_BONUS_TIME", "TF_COND_CRITBOOSTED_CARD_EFFECT", "TF_COND_CRITBOOSTED_CTF_CAPTURE",
			"TF_COND_CRITBOOSTED_DEMO_CHARGE", "TF_COND_CRITBOOSTED_FIRST_BLOOD", "TF_COND_CRITBOOSTED_ON_KILL",
			"TF_COND_CRITBOOSTED_PUMPKIN", "TF_COND_CRITBOOSTED_RAGE_BUFF", "TF_COND_CRITBOOSTED_RUNE_TEMP", "TF_COND_CRITBOOSTED_USER_BUFF",
			"TF_COND_DEFENSEBUFF", "TF_COND_DEFENSEBUFF_HIGH", "TF_COND_DEFENSEBUFF_NO_CRIT_BLOCK", "TF_COND_DEMO_BUFF",
			"TF_COND_DISGUISE_WEARINGOFF", "TF_COND_DISGUISED", "TF_COND_DISGUISED_AS_DISPENSER", "TF_COND_DISGUISING", "TF_COND_ENERGY_BUFF",
			"TF_COND_FEIGN_DEATH", "TF_COND_FIRE_IMMUNE", "TF_COND_FREEZE_INPUT", "TF_COND_GAS", "TF_COND_GRAPPLED_BY_PLAYER",
			"TF_COND_GRAPPLED_TO_PLAYER", "TF_COND_GRAPPLINGHOOK", "TF_COND_GRAPPLINGHOOK_BLEEDING", "TF_COND_GRAPPLINGHOOK_LATCHED",
			"TF_COND_GRAPPLINGHOOK_SAFEFALL", "TF_COND_HALLOWEEN_BOMB_HEAD", "TF_COND_HALLOWEEN_GHOST_MODE", "TF_COND_HALLOWEEN_GIANT",
			"TF_COND_HALLOWEEN_HELL_HEAL", "TF_COND_HALLOWEEN_IN_HELL", "TF_COND_HALLOWEEN_KART", "TF_COND_HALLOWEEN_KART_CAGE",
			"TF_COND_HALLOWEEN_KART_DASH", "TF_COND_HALLOWEEN_QUICK_HEAL", "TF_COND_HALLOWEEN_SPEED_BOOST", "TF_COND_HALLOWEEN_THRILLER",
			"TF_COND_HALLOWEEN_TINY", "TF_COND_HASRUNE", "TF_COND_HEALING_DEBUFF", "TF_COND_HEALTH_BUFF", "TF_COND_HEALTH_OVERHEALED",
			"TF_COND_INVULNERABLE", "TF_COND_INVULNERABLE_CARD_EFFECT", "TF_COND_INVULNERABLE_HIDE_UNLESS_DAMAGED",
			"TF_COND_INVULNERABLE_USER_BUFF", "TF_COND_INVULNERABLE_WEARINGOFF", "TF_COND_KING_BUFFED", "TF_COND_KNOCKED_INTO_AIR",
			"TF_COND_LOST_FOOTING", "TF_COND_MAD_MILK", "TF_COND_MARKEDFORDEATH", "TF_COND_MARKEDFORDEATH_SILENT", "TF_COND_MEDIGUN_DEBUFF",
			"TF_COND_MEDIGUN_SMALL_BLAST_RESIST", "TF_COND_MEDIGUN_SMALL_BULLET_RESIST", "TF_COND_MEDIGUN_SMALL_FIRE_RESIST",
			"TF_COND_MEDIGUN_UBER_BLAST_RESIST", "TF_COND_MEDIGUN_UBER_BULLET_RESIST", "TF_COND_MEDIGUN_UBER_FIRE_RESIST",
			"TF_COND_MEGAHEAL", "TF_COND_MELEE_ONLY", "TF_COND_MINICRITBOOSTED_ON_KILL", "TF_COND_MVM_BOT_STUN_RADIOWAVE",
			"TF_COND_NOHEALINGDAMAGEBUFF", "TF_COND_OBSCURED_SMOKE", "TF_COND_OFFENSEBUFF", "TF_COND_PARACHUTE_ACTIVE",
			"TF_COND_PARACHUTE_DEPLOYED", "TF_COND_PASSTIME_INTERCEPTION", "TF_COND_PASSTIME_PENALTY_DEBUFF", "TF_COND_PHASE",
			"TF_COND_PLAGUE", "TF_COND_POWERUPMODE_DOMINANT", "TF_COND_PREVENT_DEATH", "TF_COND_PURGATORY", "TF_COND_RADIUSHEAL",
			"TF_COND_RADIUSHEAL_ON_DAMAGE", "TF_COND_REGENONDAMAGEBUFF", "TF_COND_REPROGRAMMED", "TF_COND_ROCKETPACK",
			"TF_COND_RUNE_AGILITY", "TF_COND_RUNE_HASTE", "TF_COND_RUNE_IMBALANCE", "TF_COND_RUNE_KING", "TF_COND_RUNE_KNOCKOUT",
			"TF_COND_RUNE_PLAGUE", "TF_COND_RUNE_PRECISION", "TF_COND_RUNE_REFLECT", "TF_COND_RUNE_REGEN", "TF_COND_RUNE_RESIST",
			"TF_COND_RUNE_STRENGTH", "TF_COND_RUNE_SUPERNOVA", "TF_COND_RUNE_VAMPIRE", "TF_COND_SAPPED", "TF_COND_SELECTED_TO_TELEPORT",
			"TF_COND_SHIELD_CHARGE", "TF_COND_SNIPERCHARGE_RAGE_BUFF", "TF_COND_SODAPOPPER_HYPE", "TF_COND_SPEED_BOOST",
			"TF_COND_STEALTHED", "TF_COND_STEALTHED_BLINK", "TF_COND_STEALTHED_USER_BUFF", "TF_COND_STEALTHED_USER_BUFF_FADING",
			"TF_COND_STUNNED", "TF_COND_SWIMMING_CURSE", "TF_COND_SWIMMING_NO_EFFECTS", "TF_COND_TAUNTING", "TF_COND_TEAM_GLOWS",
			"TF_COND_TELEPORTED", "TF_COND_TMPDAMAGEBONUS", "TF_COND_URINE", "TF_COND_ZOOMED"
		}, {}, FDropdownEnum::Right); break;
		}
		bLastHovered |= bHovered;
	...
	{ \
		...
		if (pHovered) \
			*pHovered = bHovered; \
		if (!(var.m_iFlags & NOBIND) && !(var.m_iFlags & NOSAVE && !Vars::Config::LoadDebugSettings.Value) && !Disabled && CurrentBind == DEFAULT_BIND) \
	...
	inline bool FToggleSlider(ConfigVar<bool>& toggleVar, ConfigVar<float>& sliderVar, int iToggleFlags = FToggleEnum::None, int iSliderFlags = FSliderEnum::None, const char* sFormatOverride = nullptr, bool* pHovered = nullptr)
	{
		...
		if (!(toggleVar.m_iFlags & NOBIND) && !(toggleVar.m_iFlags & NOSAVE && !Vars::Config::LoadDebugSettings.Value) && !Disabled && CurrentBind == DEFAULT_BIND)
		{
